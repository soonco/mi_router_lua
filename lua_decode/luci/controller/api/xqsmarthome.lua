...
function L3()
  ...
  if L7 then
    ...
    if L7 then
      ...
      L7 = L7[1]
      L7 = L7.type
      if L7 ~= "normal_reboot" then
        L7 = L3.action_list
        L7 = L7[1]
        L7 = L7.type
        if L7 ~= "normal_wifi_down" then
          goto lbl_76
        end
      end
      ...
      L9 = "\"}';"
      L10 = "sleep 2;"
      L11 = "ubus call xq_info_sync_mqtt smart_changed"
      L6 = L7 .. L8 .. L9 .. L10 .. L11
      L7 = L0.log
      L8 = 6
      L9 = "trafficd: "
  ...
  ::lbl_76::
  L7 = _UPVALUE2_
  L7 = L7.THRIFT_TUNNEL_TO_SMARTHOME_CONTROLLER
  L6 = L7 % L4
  L7 = _UPVALUE1_
  L7 = L7.write
  L8 = L5.exec
