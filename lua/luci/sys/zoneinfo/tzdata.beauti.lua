--[[
  ...
  提供世界各地时区名称与POSIX TZ字符串的映射表
  TZ字符串格式说明:
  - 标准时区缩写 + UTC偏移量 (如 "CST-8" 表示中国标准时间 UTC+8)
  - 可选的夏令时规则 (如 "EST5EDT,M3.2.0,M11.1.0" 表示美国东部时间带夏令时)
  
  数据结构: { {时区名称, POSIX TZ字符串}, ... }
]]
...
TZ = {
  ...
  { "America/Santiago", "CLT4CLST,M10.2.0/0,M3.2.0/0" },
  ...
  { "Antarctica/Palmer", "CLT4CLST,M10.2.0/0,M3.2.0/0" },
  ...
  { "Asia/Dubai", "GST-4" },
  { "Asia/Dushanbe", "TJT-5" },
  { "Asia/Gaza", "EET-2EEST,M3.5.6/0:01,M9.3.5/1" },
  { "Asia/Harbin", "CST-8" },
  { "Asia/Hebron", "EET-2EEST,M3.5.6/0:01,M9.3.5/1" },
  ...
  { "Pacific/Easter", "EAST6EASST,M10.2.0/0,M3.2.0/0" },
